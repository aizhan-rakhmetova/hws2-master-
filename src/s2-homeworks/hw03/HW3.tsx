...
export const pureAddUserCallback = (name: string, setUsers: (users: UserType[] )=>void, users: UserType[]) => { // need to check
    const user = {_id: v1(), name: name}    // need to fix// UserType
    setUsers([...users, user])
}
